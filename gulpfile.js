...
gulp.task('sync', function (cb) {
  async.series(
    [
      function (next) {
        gulp
          .src(['node_modules/universalviewer/dist/uv-*/**'])
      ...
      function (next) {
        gulp
          .src(['node_modules/extensions/dist/extensions.js'])
          .pipe(gulp.dest('vendor/extensions'))
          .on('end', next);
      },
      function (next) {
        gulp
          .src(['node_modules/jquery-plugins/dist/jquery-plugins.js'])
          .pipe(gulp.dest('vendor/jquery-plugins'))
          .on('end', next);
      },
      function (next) {
        gulp
          .src(['node_modules/utils/dist/utils.js'])
